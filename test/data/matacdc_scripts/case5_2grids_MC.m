...
mpc.bus = [
  ...
  6       3       0	0	0   0   2       1.06	0	345     1       1.1     0.9;
	...
	11      1       100	10	0   0   2       1       0	345     1       1.1     0.9;
...
mpc.convdc = [
	...
	3      11   2       1       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 100 -100 50 -50 1 3 0.5 2;
];
...
mpc.branchdc = [
  1       4       0.052   0   0    100     100     100     1  2 2 0.04 0;  %bipolar
	...
	3       4       0.052   0   0    100     100     100     1  1 2 0.04 2;  %monopolar
 ];
