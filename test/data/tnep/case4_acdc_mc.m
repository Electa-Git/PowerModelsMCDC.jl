...
%	  1  4   0.020   0.06   0.00   250  250  250  0  0  1 -60  60;
...
mpc.convdc = [
    1       2   1       1       0       0    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     11     1       0 0  0    0      0.0050    -58.6274   1.0079   0 250 -250 100 -100 2 0 1 0.5;
    2       3   1       1       0       0    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     11     1       0 0  0    0      0.0070     21.9013   1.0000   0 250 -250 100 -100 2 0 0 0.5;
];

%     1       2   1       1       0       0    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     11     1       1.103 0.887  2.885    1.885      0.0050    -58.6274   1.0079   0 300 -300 100 -100 2 0 0 0.5;
%     2       3   2       1       0       0    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     11     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 300 -300 100 -100 2 0 0 0.5;

%% branches
%column_names%   fbusdc  tbusdc  r      l        c   rateA   rateB   rateC   status line_confi return_type return_z connect_at
mpc.branchdc = [
    1       2       0.052   0   0    250     250     250     1  2 2 0.04 0;
 ];
...
%% candidate branches
%column_names%   fbusdc  tbusdc  r      l        c   rateA   rateB   rateC status cost line_confi return_type return_z connect_at
mpc.branchdc_ne = [
    3       4       0.052   0   0    200     150     150     1 1 2 2 0.04 0 2 2 0.04 0;
    3       5       0.052   0   0    200     150     150     1 1 2 2 0.04 0 2 2 0.04 0;
    3       1       0.052   0   0    200     150     150     1 1 2 2 0.04 0 2 2 0.04 0;
 ];

%% candidate converters
%column_names%   busdc_i busac_i type_dc type_ac P_g   Q_g  islcc  Vtar rtf xtf  transformer tm   bf filter    rc      xc  reactor   basekVac Vmmax   Vmmin   Imax    status   LossA LossB  LossCrec LossCinv  droop Pdcset    Vdcset  dVdcset Pacmax Pacmin Qacmax Qacmin cost conv_confi connect_at ground_type ground_z
mpc.convdc_ne = [
