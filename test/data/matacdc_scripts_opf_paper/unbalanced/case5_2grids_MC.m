...
mpc.bus = [
  ...
  6       1       0	0	0   0   2       1.06	0	345     1       1.1     0.9;
	...
	11      1       50	10	0   0   3       1       0	345     1       1.1     0.9;
...
mpc.convdc = [
    1       2   2       1       -60    -40    0 1     0.02  0.02 1 1 0.005 1 0.02   0.02 1  345         1.1     0.9     1.1     1       0.5515 0.887  5.77    3.77      0.0050    -58.6274   1.0079   0 100 -100 50 -50 1 2 1 0.5 ;
    2       7   1       1       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 100 -100 50 -50 2 0 0 0.5 ;
		3      11   1       1       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 100 -100 50 -50 2 0 0 0.5 ;
];

%% branches
%column_names%   fbusdc  tbusdc  r      l        c   rateA   rateB   rateC   status conductors return_type return_z connect_at
mpc.branchdc = [
  1       4       0.052   0   0    100     100     100     1  3 2 0.052 0;  %bipolar
  2       4       0.052   0   0    100     100     100     1  3 2 0.052 0;  %bipolar
  3       4       0.052   0   0     50      50      50     1  3 2 0.052 2;  %monopolar
 ];
