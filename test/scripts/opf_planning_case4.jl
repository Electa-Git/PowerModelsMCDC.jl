...
for i in 1:length( df[!,"1"])
    ...
    save_results_detailed_case4 = DataFrame( c1 = [], c2 = [], c3 = [], c4 = [])
    push!(save_results_detailed_case4, [result_mcdc_opf["termination_status"], result_mcdc_opf["objective"], wind_curtail, weight])
    CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_detailed_case4.csv", save_results_detailed_case4, append = true)
end
...
save_results_summary_case4 = DataFrame( c1 = [], c2 = [], c3 = [], )
push!(save_results_summary_case4, [average_result1, average_result2, average_result3])
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_summary_case4.csv", save_results_summary_case4, append = true)
