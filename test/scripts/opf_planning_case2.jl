...
for i in 1:length( df[!,"1"])
    ...
    save_results_detailed_case2 = DataFrame( c1 = [], c2 = [], c3 = [], c4 = [])
    push!(save_results_detailed_case2, [result_mcdc_opf["termination_status"], result_mcdc_opf["objective"], wind_curtail, weight])
    CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_detailed_case2.csv", save_results_detailed_case2, append = true)
end
...
save_results_summary_case2 = DataFrame( c1 = [], c2 = [], c3 = [], )
push!(save_results_summary_case2, [average_result1, average_result2, average_result3])
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_summary_case2.csv", save_results_summary_case2, append = true)
