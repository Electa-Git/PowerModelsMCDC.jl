...
for (cv, convdc) in data["convdc"]
    ...
    convdc["Q_g"] = -resultAC["solution"]["convdc"]["$cv"]["qgrid"]
    convdc["P_g"] = -resultAC["solution"]["convdc"]["$cv"]["pgrid"]
...
println("termination status of the MCDC opf is:", result_mcdc_opf1["termination_status"])
println("termination status of the MCDC pf is:", result_mcdc_pf1["termination_status"])

# ######################### compare ACDC results #########################
#  [_PM.component_table(resultAC["solution"], "bus", ["va"]) _PM.component_table(resultAC_pf["solution"], "bus", ["va"])]
#  [_PM.component_table(resultAC["solution"], "bus", ["vm"]) _PM.component_table(resultAC_pf["solution"], "bus", ["vm"])]
#  [_PM.component_table(resultAC["solution"], "busdc", ["vm"]) _PM.component_table(resultAC_pf["solution"], "busdc", ["vm"])]
#  [_PM.component_table(resultAC["solution"], "convdc", ["pdc"]) _PM.component_table(resultAC_pf["solution"], "convdc", ["pdc"])]
#  [_PM.component_table(resultAC["solution"], "convdc", ["iconv"]) _PM.component_table(resultAC_pf["solution"], "convdc", ["iconv"])]
#  [_PM.component_table(resultAC["solution"], "convdc", ["pconv"]) _PM.component_table(resultAC_pf["solution"], "convdc", ["pconv"])]
#  [_PM.component_table(resultAC["solution"], "convdc", ["pgrid"]) _PM.component_table(resultAC_pf["solution"], "convdc", ["pgrid"])]
#  [_PM.component_table(resultAC["solution"], "convdc", ["qgrid"]) _PM.component_table(resultAC_pf["solution"], "convdc", ["qgrid"])]
# [_PM.component_table(resultAC["solution"], "gen", ["pg"]) _PM.component_table(resultAC_pf["solution"], "gen", ["pg"])]
# [_PM.component_table(resultAC["solution"], "gen", ["qg"]) _PM.component_table(resultAC_pf["solution"], "gen", ["qg"])]

# # ######################### compare MCDC results #########################
