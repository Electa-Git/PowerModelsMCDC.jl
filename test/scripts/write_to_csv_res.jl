...
push!(conv_sp, ["Conv no", "Pc=pgrid", "Qc=qgrid", "Pdc", "Pdcg"])
...
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecase_gen.csv", basecase_gen, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecase_conv.csv", basecase_conv, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecasev.csv", basecase_v, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecasevdc.csv", basecase_vdc, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecase_br.csv", basecase_br, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/basecase_brdc.csv", basecase_brdc, append = true)
# conv_settings
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/conv_settings.csv", conv_sp, append = true)
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/conv_sp.csv", conv_sp, append=true)
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/gen_sp.csv", gen_sp, append=true)
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/volt.csv", volt, append=true)
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/voltdc.csv", voltdc, append=true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/cost_total.csv", cost_total, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/cost_nw.csv", cost_nw, append = true)
# CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF/simulations/Nov28/loadsp.csv", loadsp, append = true)
