...
for i in 1:length( df[!,"1"])
    ...
    save_results_detailed_case1 = DataFrame( c1 = [], c2 = [], c3 = [], c4 = [])
    push!(save_results_detailed_case1, [result_mcdc_opf["termination_status"], result_mcdc_opf["objective"], wind_curtail, weight])
    CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_detailed_case1.csv", save_results_detailed_case1, append = true)
end
...
save_results_summary_case1 = DataFrame( c1 = [], c2 = [], c3 = [], )
push!(save_results_summary_case1, [average_result1, average_result2, average_result3])
CSV.write("/Users/cjat/OneDrive - Energyville/PM MCDC PF Francesco/Simulations June 2024/planning related OPF/with 120 wighted samples/save_results_summary_case1.csv", save_results_summary_case1, append = true)
...
data["branchdc"]["1"]["rateA"] = 1.0
data["branchdc"]["1"]["rateB"] = 1.0
data["branchdc"]["1"]["rateC"] = 1.0
for (i, busdc) in data["busdc"]
    busdc["Vdcmax"][3] = 0.1
end
results = Dict{String, Vector{Float64}}()
...
data["branchdc"]["2"]["rateA"] = 1.0
data["branchdc"]["2"]["rateB"] = 1.0
data["branchdc"]["2"]["rateC"] = 1.0
for (i, busdc) in data["busdc"]
    busdc["Vdcmax"][3] = 0.1
end
results = Dict{String, Vector{Float64}}()
...
data["branchdc"]["3"]["rateA"] = 1.0
data["branchdc"]["3"]["rateB"] = 1.0
data["branchdc"]["3"]["rateC"] = 1.0
results = Dict{String, Vector{Float64}}()
for (i, busdc) in data["busdc"]
    busdc["Vdcmax"][3] = 0.1
end
...
data["branchdc"]["4"]["rateA"] = 1.0
data["branchdc"]["4"]["rateB"] = 1.0
data["branchdc"]["4"]["rateC"] = 1.0
for (i, busdc) in data["busdc"]
    busdc["Vdcmax"][3] = 0.1
end
...
data["branchdc"]["5"]["rateA"] = 1.0
data["branchdc"]["5"]["rateB"] = 1.0
data["branchdc"]["5"]["rateC"] = 1.0
for (i, busdc) in data["busdc"]
    busdc["Vdcmax"][3] = 0.1
end
results = Dict{String, Vector{Float64}}()
