...
```
"""
function constraint_kcl_shunt_new(pm::_PM.AbstractDCPModel, n::Int, i::Int, bus_arcs, bus_gens, bus_conv_poles, bus_loads, bus_shunts, pd, qd, gs, bs)
    p = _PM.var(pm, n, :p)
    pg = _PM.var(pm, n, :pg)
    pconv_grid_ac = _PM.var(pm, n, :pconv_tf_fr)
    vm = 1
...
function constraint_ohms_dc_branch_new(pm::_PM.AbstractDCPModel, n::Int, f_bus, t_bus, f_idx, t_idx, branch)
